"""
Django settings for SelfUserAuth_Login project.
...
SECRET_KEY = '54xvt7wa_^4&5hwz#elznii&0utx*cvu7oau=)!=+3@^9e5l)m'
...
ROOT_URLCONF = 'SelfUserAuth_Login.urls'
...
WSGI_APPLICATION = 'SelfUserAuth_Login.wsgi.application'
